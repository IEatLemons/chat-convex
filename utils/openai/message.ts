...
export default class Message extends Request {
    ...
    public get = async (params: GetParams) =>
        this.request(
    ...
    public create = async (params: CreateRequest): Promise<MessageResult> =>
        this.request(`${this.apiUrl()}/threads/${params.thread_id}/messages`, {
            method: 'POST',
            headers: this.headers(),
            body: JSON.stringify({
                role: params.role,
