...
export default class Assistant extends Request {
    ...
    public delete = async (assistant_id: string) => this.request(
        `${this.apiUrl()}/assistants/${assistant_id}`,
        {
            method: 'DELETE',
            headers: this.headers(),
        }
    ...
    public file_list = async (id: string) => this.request(
        `${this.apiUrl()}/assistants/${id}/files`,
        {
            method: 'GET',
            headers: this.headers(),
        }
